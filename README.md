...
Many households are unaware of whether rainwater harvesting is feasible for their location. Even when information is available, it is often scattered across technical reports and government manuals, making it difficult for common users to understand or apply.

This project aims to bridge that gap by providing:

-Location-based rainfall analysis

-Groundwater and aquifer suitability insights

-Harvest potential estimation

-Cost estimation and payback prediction
...
-Location (Pincode / GPS / Manual selection)

-Roof type and roof area

-Household water usage details
...
-Aquifer & Groundwater Logic Integration
...
This solution is designed to support sustainable water management by:

-Encouraging adoption of rooftop rainwater harvesting

-Helping reduce dependency on external water supply sources
...
https://github.com/smeraagrawal/SIH-Rainwater-Harvesting
